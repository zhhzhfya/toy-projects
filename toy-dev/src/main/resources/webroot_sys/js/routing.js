...
var target = source.clone().translate(250, 400).attr('text/text', 'Target');
...
var obstacles = [ obstacle, obstacle.clone().translate(200, 100), obstacle.clone().translate(-200, 150) ];
